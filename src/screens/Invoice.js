                        ...
                        <div className="row page-titles">
                            ...
                            <div className="col-md-7 align-self-center text-end">
                                <div className="d-flex justify-content-end align-items-center">
                                    <a role="button" className="btn waves-effect waves-light btn-rounded btn-outline-success"  href="/addinvoice">
                                            ...
                                            <table id="myTable" className="table table-striped border">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>2500</td>
                                                        <td>Paid/unpaid</td>
                                                        <td><a role="button" className="btn btn-circle btn-info" href="/viewinvoice">
