      ...
      .map((product, index) => {
        return {
          ...
          action: (
            <>
              <NavLink
                to={`/editproduct/${product._id}/edit`}
                role="button"
            ...
            <div className="row page-titles">
              ...
              <div className="col-md-7 align-self-center text-end">
                  <div className="d-flex justify-content-end align-items-center">
                      <a role="button" className="btn waves-effect waves-light btn-rounded btn-outline-success"  onClick={createProductHandler}>
              ...
              <div className="col-12">
                <div className="card">
                  <div className="card-body">
                    <h3 className="card-title">Product List Details</h3>
