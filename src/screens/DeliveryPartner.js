                        ...
                        <div className="row page-titles">
                            ...
                            <div className="col-md-7 align-self-center text-end">
                                <div className="d-flex justify-content-end align-items-center">
                                    <a role="button" className="btn waves-effect waves-light btn-rounded btn-outline-success"  href="/adddeliverypartner">
                                        ...
                                        </svg> Create New Delivery Partner
                                    </a>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <table id="myTable" className="table table-striped border">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Kovai Boys</td>
                                                        <td>123456789</td>
                                                        <td>Peelamedu, Gandhipuram</td>
                                                        <td>Siva</td>
                                                        <td><a role="button" className=" btn btn-circle btn-success" href="/editdeliverypartner">
