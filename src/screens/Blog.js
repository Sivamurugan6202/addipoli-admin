                        ...
                        <div className="row page-titles">
                            ...
                            <div className="col-md-7 align-self-center text-end">
                                <div className="d-flex justify-content-end align-items-center">
                                    <a role="button" className="btn waves-effect waves-light btn-rounded btn-outline-success"  href="/addblog">
                        ...
                        <div className="row">
                            ...
                            <div className="card">
                                    <div className="card-body">
                                        <h3 className="card-title">Blog List Details</h3>
                                            ...
                                            <table id="myTable" className="table table-striped border">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>01/01/2020</td>
                                                        <td>Ran</td>
                                                        <td><a role="button" className="btn btn-circle btn-success" href="/editblog">
