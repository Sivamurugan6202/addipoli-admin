                        ...
                        <div className="row page-titles">
                            <div className="col-md-5 align-self-center">
                                <ol className="breadcrumb justify-content">
                                    ...
                                    <li className="breadcrumb-item active">Coupon List Details</li>
                                </ol>
                            </div>
                            <div className="col-md-7 align-self-center text-end">
                                <div className="d-flex justify-content-end align-items-center">
                                    <a role="button" className="btn waves-effect waves-light btn-rounded btn-outline-success"  href="/addcoupon">
                        ...
                        <div className="row">
                            ...
                            <div className="card">
                                    <div className="card-body">
                                        <h3 className="card-title">Coupon List Details</h3>
                                            ...
                                            <table id="myTable" className="table table-striped border">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>100</td>
                                                        <td>199</td>
                                                        <td><a role="button" className="btn btn-circle btn-success" href="/editcoupon">
