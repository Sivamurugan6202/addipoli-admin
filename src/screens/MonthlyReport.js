                    ...
                    <div className="container-fluid">
                                            ...
                                            <div className="row pt-3">
                                                ...
                                                <div className="col-md-3 align-self-center text-end">
                                                    <div className="d-flex justify-content-end align-items-center">
                                                        <a role="button" className="btn waves-effect waves-light btn-rounded btn-outline-success" style={{width:"140px", marginRight:"40px", marginTop:"5px"}} href="/adddeliverypartner">
                                                            Submit
                                                        </a>
                                                    </div>
                                                </div>                                                    
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="card">
                                    <div className="card-body">
                                        <h3 className="card-title">Profit Report</h3>
                                        <div className="table-responsive m-t-40">
                                            <table id="myTable" className="table table-striped border">
                                                <thead>
                                                    <tr>
