                        ...
                        <div className="row page-titles">
                            <div className="col-md-5 align-self-center">
                                <ol className="breadcrumb justify-content">
                                    ...
                                    <li className="breadcrumb-item active">Hub Details</li>
                                </ol>
                            </div>
                            <div className="col-md-7 align-self-center text-end">
                                <div className="d-flex justify-content-end align-items-center">
                                    <a role="button" className="btn waves-effect waves-light btn-rounded btn-outline-success"  href="/addhub">
                        ...
                        <div className="row">
                            ...
                            <div className="card">
                                    <div className="card-body">
                                        <h3 className="card-title">Hub Details</h3>
                                            ...
                                            <table id="myTable" className="table table-striped border">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Siva</td>
                                                        <td>123456789</td>
                                                        <td><a role="button" className="btn btn-circle btn-success" href="/edithub">
