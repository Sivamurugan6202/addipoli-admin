                        ...
                        <div className="row page-titles">
                            <div className="col-md-5 align-self-center">
                                <ol className="breadcrumb justify-content">
                                    ...
                                    <li className="breadcrumb-item active">Raw Material List</li>
                                </ol>
                            </div>
                            <div className="col-md-7 align-self-center text-end">
                                <div className="d-flex justify-content-end align-items-center">
                                    <a role="button" className="btn waves-effect waves-light btn-rounded btn-outline-success"  href="/addrawmaterial">
                            ...
                            <div className="col-12">
                                <div className="card">
                                    <div className="card-body">
                                        <h3 className="card-title">Raw Material List</h3>
                                            ...
                                            <table id="myTable" className="table table-striped border">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>AP01</td>
                                                        <td>Puttu</td>                                                        
                                                        <td><a role="button" className=" btn btn-circle btn-success" href="/editrawmaterial">
